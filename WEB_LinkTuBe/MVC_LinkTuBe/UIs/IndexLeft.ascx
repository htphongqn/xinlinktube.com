<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IndexLeft.ascx.cs" Inherits="MVC_LinkTuBe.UIs.IntroIndex" %>
...
<div class="iblock link-hot">
    <div class="tt-side"><span> Link Mới</span> </div>
    <div class="slider-ht">
    <asp:Repeater ID="re_linknews" runat="server">
        <ItemTemplate>
             <div class="slide">
   ...
   <div class="iblock link-hot">
    <div class="tt-side"><span> Link đề xuất</span> </div>
    <div class="slider-ht2">
