    ...
    public partial class toolbar : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                hplClose.HRef = "/" + _sNews_Seo_Url + ".html";
            }
        }
        ...
        protected void lbtFeedback_Click(object sender, EventArgs e)
        {
            ...
            {
                string _sCat_Seo_Url = Utils.CStrDef(Request.QueryString["purl"]);
        ...
        private void SendEmailFeedback()
        {
            try
            {
                ...
                if (_FeedEmail.ToList().Count > 0)
                {
                    ...
                    strEmailSubject += "Thông tin phản hồi từ website " + System.Configuration.ConfigurationManager.AppSettings["EmailDisplayName"];
                    strEmailBody += "<html><body>";
