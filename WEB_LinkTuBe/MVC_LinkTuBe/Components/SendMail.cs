...
namespace MVC_LinkTuBe.Components
{
    public class SendMail
    {
        ...
        public void SendEmailSMTP(string strSubject, string toAddress, string ccAddress, string ccAddress1, string bccAddress, string body, bool isHtml, bool isSSL)
        {
            try
            {
                using (MailMessage mail = new MailMessage())
