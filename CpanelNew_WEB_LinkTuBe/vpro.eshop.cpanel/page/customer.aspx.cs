        ...
        private void getInfo()
        {
            try
            {
                ...
                if (G_info.ToList().Count > 0)
                {
                    ...
                    rbl_trangthai.SelectedValue = Utils.CStrDef(G_info.ToList()[0].CUSTOMER_FIELD4);
                    Dryear.SelectedValue = DateTime.Parse(Utils.CStrDef(G_info.ToList()[0].CUSTOMER_PUBLISHDATE)).Year.ToString();
                    Drmonth.SelectedValue = DateTime.Parse(Utils.CStrDef(G_info.ToList()[0].CUSTOMER_PUBLISHDATE)).Month.ToString();
                    Drday.SelectedValue = DateTime.Parse(Utils.CStrDef(G_info.ToList()[0].CUSTOMER_PUBLISHDATE)).Day.ToString();
                    ...
                    txtCustomerUL.Value = Utils.CStrDef(G_info.ToList()[0].CUSTOMER_EMAIL);
                }
            }
            catch (Exception ex)
            {
