...
namespace vpro.eshop.cpanel.page
{
    public partial class news_editor : System.Web.UI.Page
    {
        ...
        //        pathFile = Server.MapPath(PathFiles.GetPathNews(m_news_id) + "/" + newsInfo.ToList()[0].NEWS_FIELD1);
        ...
        //        pathFile = Server.MapPath(PathFiles.GetPathNews(m_news_id) + "/" + newsInfo.ToList()[0].NEWS_FIELD5);
        ...
        //            strFileName = PathFiles.GetPathNews(m_news_id) + m_news_id.ToString() + "-vi1.htm";
        //            strHTMLFileLocation = Server.MapPath(strFileName);
        ...
        //            if (n_update.ToList().Count > 0)
        //            {
        //                n_update.Single().NEWS_FIELD1 = m_news_id.ToString() + "-vi1.htm";
        ...
        //            strFileName = PathFiles.GetPathNews(m_news_id) + m_news_id.ToString() + "-vi2.htm";
        //            strHTMLFileLocation = Server.MapPath(strFileName);
        ...
        //            if (n_update.ToList().Count > 0)
        //            {
        //                n_update.Single().NEWS_FIELD5 = m_news_id.ToString() + "-vi2.htm";
