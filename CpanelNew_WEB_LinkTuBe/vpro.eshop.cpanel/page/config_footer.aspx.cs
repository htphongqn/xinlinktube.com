    ...
    public partial class config_footer : System.Web.UI.Page
    {
        ...
        private void showFileHTML1()
        {
            try
            {
                string pathFile;
                string strHTMLContent;
                pathFile = Server.MapPath(PathFiles.GetPathFooter() + "/sologan-vi.htm");
                if ((File.Exists(pathFile)))
                {
                    StreamReader objNewsReader;
                    //objNewsReader = New StreamReader(pathFile, System.Text.Encoding.Default)
        ...
        private void showFileHTML2()
        {
            try
            {
                string pathFile;
                string strHTMLContent;
                pathFile = Server.MapPath(PathFiles.GetPathFooter() + "/thanhtruot-vi.htm");
                if ((File.Exists(pathFile)))
                {
                    StreamReader objNewsReader;
                    //objNewsReader = New StreamReader(pathFile, System.Text.Encoding.Default)
        ...
        //        string pathFile;
        //        string strHTMLContent;
        //        pathFile = Server.MapPath(PathFiles.GetPathFooter() + "/daily-vi.htm");
        //        if ((File.Exists(pathFile)))
        //        {
        //            StreamReader objNewsReader;
        //            //objNewsReader = New StreamReader(pathFile, System.Text.Encoding.Default)
        ...
        private void SaveHTMLInfo1()
        {
            try
            {
                ...
                strFileName = PathFiles.GetPathFooter() + "/sologan-vi.htm";
                strHTMLFileLocation = Server.MapPath(strFileName);
        ...
        //        strFileName = PathFiles.GetPathFooter() + "/daily-vi.htm";
        //        strHTMLFileLocation = Server.MapPath(strFileName);
