...
namespace vpro.eshop.cpanel.page
{
    public partial class online_list : System.Web.UI.Page
    {
        ...
        public string getLink(object obj_id)
        {
            ...
            //<asp:ListItem Selected="True" Value="0" Text="Yahoo+Skype+Phone"></asp:ListItem>
            //                <asp:ListItem Value="2" Text="Hotline"></asp:ListItem>
            //                <asp:ListItem Value="1" Text="Skype"></asp:ListItem>
            //               <asp:ListItem Value="12" Text="Điện thoại bàn"></asp:ListItem>
                //            <asp:ListItem Value="9" Text="Viper"></asp:ListItem>
                 //           <asp:ListItem Value="10" Text="Zalo"></asp:ListItem>
            ...
            //                <asp:ListItem Value="7" Text="In"></asp:ListItem>
        ...
        public string getType(object obj_type)
        {
            ...
            {
                case 0: _res = "Hỗ trợ"; break;
                case 1: _res = "Skype"; break;
                case 2: _res = "Hotline"; break;
                case 3: _res = "Facebook"; break;
                case 4: _res = "Skype"; break;
                case 5: _res = "Twitter"; break;
                case 6: _res = "Youtube"; break;
                case 7: _res = "Linkedin"; break;
                case 8: _res = "Pinterest"; break;
                case 9: _res = "Viper"; break;
                case 10: _res = "Zalo"; break;
                case 11: _res = "Fanpage"; break;
                case 12: _res = "Điện thoại bàn"; break;
            }
            return _res;
        }
