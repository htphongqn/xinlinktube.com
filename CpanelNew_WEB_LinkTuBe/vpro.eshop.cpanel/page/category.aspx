...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row page-header">
        ...
        <div class="col-sm-7 navbar-right" style="display:none;">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <asp:RadioButtonList ID="rblCatType" runat="server">
                                ...
                                <asp:ListItem Text="Kênh" Value="2"></asp:ListItem>
                        ...
                        <div class="form-group">
                            ...
                            <asp:RadioButtonList ID="rblPos" runat="server" RepeatColumns="2">
                                <asp:ListItem Text="Menu chính" Value="1" Selected="True"></asp:ListItem>
                                <asp:ListItem Text="Kênh mặc định" Value="2"></asp:ListItem>
                                <asp:ListItem Text="Khác" Value="10"></asp:ListItem>
                            </asp:RadioButtonList>
                        </div>
                        <div class="form-group">
