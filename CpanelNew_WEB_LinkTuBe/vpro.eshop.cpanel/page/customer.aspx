                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            ValidationGroup="G1"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" CssClass="label label-danger" runat="server" ErrorMessage="Email chưa đúng dịnh dạng" ControlToValidate="txtCustomerEmail" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ValidationGroup="G1">Email chưa đúng dịnh dạng</asp:RegularExpressionValidator>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">
                 ...
                 <%--           <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Vui lòng nhập quận/huyện"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                           ...
                           <div class="form-group" id="div_trangthai" runat="server">
                        <label class="col-sm-3 control-label">
                            Trạng thái</label>
                        <div class="col-sm-9">
                            <asp:RadioButtonList ID="rbl_trangthai" runat="server" RepeatColumns="5">
                                <asp:ListItem Text="Chưa kích hoạt" Value="0" Selected="True"></asp:ListItem>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <label>
                            Email</label>
                        <input type="text" name="txtCustomerUL" id="txtCustomerUL" runat="server" class="form-control" />
                         <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ErrorMessage="Vui lòng nhập tên đăng nhập !"
                                Text="Vui lòng nhập tên đăng nhập !" ControlToValidate="txtCustomerUL" CssClass="label label-danger"
                                ValidationGroup="G1"></asp:RequiredFieldValidator>
