        ...
        private void getInfo()
        {
            try
            {
                ...
                if (G_info.ToList().Count > 0)
                {
                    ...
                    txtvisitor.Value = G_info.ToList()[0].CONFIG_HITCOUNTER.ToString();
                    //image
        ...
        private void SaveInfo()
        {
            try
            {
                ...
                if (G_info.ToList().Count > 0)
                {
                    ...
                    G_info.Single().CONFIG_HITCOUNTER = Utils.CIntDef(txtvisitor.Value);
                    DB.SubmitChanges();
                }
                else
                {
                    ...
                    config_insert.CONFIG_HITCOUNTER = Utils.CIntDef(txtvisitor.Value);
